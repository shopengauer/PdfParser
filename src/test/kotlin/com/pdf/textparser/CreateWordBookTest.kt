...
import com.pdf.domain.BookStatistic
...
code generated by the Kotlin compiler is executed as efficiently as regular Java code.
    ...
    fun createEnWordTest() {
        ...
        println(bookStatistic.tokensList)
        println(bookStatistic.wordObjectList)
        println(bookStatistic.tokensSet)
        ...
        println(bookStatistic.sortAccendingTokensMap(bookStatistic.tokenOccurs))
