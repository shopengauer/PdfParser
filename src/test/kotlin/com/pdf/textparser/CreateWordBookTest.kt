...
code generated by the Kotlin compiler is executed as efficiently as regular Java code.
    ...
    fun createEnWordTest() {
        ...
        val bookStatistic = BookStatistic(testText, book)
        ...
        println(bookStatistic.sortDescendingTokensMap())
        println(bookStatistic.sortAscendingTokensMap())
        println(bookStatistic.wordsStatistics)
//        for((occurs,numberOfTokens) in bookStatistic.wordsStatistics(bookStatistic.tokenOccurs))
